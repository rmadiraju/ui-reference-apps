Feature: Vite Vue Application - Component Tests
  As a user
  I want to interact with the Vite Vue application
  ...
  Scenario: View application header
    ...
    Then I should see the application title "Vite Vue CSR Reference App"
    And I should see the subtitle "Client-Side Rendering with Vite and Vue"
    And the header should have a gradient background

  Scenario: View mocked message content
    When I visit the application
    Then I should see a message section
    And I should see the mocked message "Welcome to the Vite Vue CSR Reference Application!"
