Feature: Next.js React Application - Component Tests
  As a user
  I want to interact with the Next.js React application
  ...
  Scenario: View application header
    ...
    Then I should see the application title "Next.js React SSR Reference App"
    And I should see the subtitle "Server-Side Rendering with Next.js and React"
    And the header should have a gradient background

  Scenario: View mocked message content
    When I visit the application
    Then I should see a message section
    And I should see the mocked message "Welcome to the Next.js React SSR Reference Application!"
